...
<br>
<div class="container">
    <div class="jumbotron jumbotron-fluid" style="background-color: rgba(255, 255, 255, 0.6);">
        <br>
        <h1 class="display-4"><b>
                <center style = "color: red;">CRUD con PHP y Mongo</center>
            </b></h1>
        <br>
        <p class="lead">
            <a href="agregar.php" class="btn btn-success ml-2 btn-lg"> Agregar persona <svg
