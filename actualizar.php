...
<!-- <div class="jumbotron jumbotron-fluid" style="background: white">
    <div class="container" style="background-color: rgba(255, 255, 255, 0.6);"> -->
        ...
        <p><a href="index.php" class="btn btn-danger mt-2">regresar</a></p>
        <h1 class="display-4 text-center" style = "color: yellow;"><b>Actualizar un registro</b></h1>
        ...
        <form action="procesos/actualizar.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <button class="btn btn-warning btn-lg btn-block">Actualizar</button>
